...
import br.pucpr.authserver.articleslist.ArticlesListsRepository
import br.pucpr.authserver.articleslist.ArticlesListsService
...
class ArticlesServiceTest {
    ...
    fun `Find by current date should return current date articles`() {
        ...
        service.findAll(LocalDate.now()).count() shouldBe articles.count()
    }
}